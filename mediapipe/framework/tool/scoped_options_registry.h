...
#ifndef MEDIAPIPE_FRAMEWORK_TOOL_SCOPED_OPTIONS_REGISTRY_H_
#define MEDIAPIPE_FRAMEWORK_TOOL_SCOPED_OPTIONS_REGISTRY_H_
...
class ScopedOptionsRegistry {
 public:
  ...
  RegistrationToken Register(const FieldData& file_descriptor_set);
...
class EnhancedOptionsRegistry {
 public:
  ...
  static RegistrationToken RegisterWithRefCounting(const FieldData& file_descriptor_set,
...
#endif  // MEDIAPIPE_FRAMEWORK_TOOL_SCOPED_OPTIONS_REGISTRY_H_
