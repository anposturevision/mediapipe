...
#ifndef MEDIAPIPE_FRAMEWORK_DEPS_REFERENCE_COUNTED_REGISTRY_H_
#define MEDIAPIPE_FRAMEWORK_DEPS_REFERENCE_COUNTED_REGISTRY_H_
...
#endif  // MEDIAPIPE_FRAMEWORK_DEPS_REFERENCE_COUNTED_REGISTRY_H_
