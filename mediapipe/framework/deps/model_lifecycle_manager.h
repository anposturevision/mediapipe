...
#ifndef MEDIAPIPE_FRAMEWORK_DEPS_MODEL_LIFECYCLE_MANAGER_H_
#define MEDIAPIPE_FRAMEWORK_DEPS_MODEL_LIFECYCLE_MANAGER_H_
...
#endif  // MEDIAPIPE_FRAMEWORK_DEPS_MODEL_LIFECYCLE_MANAGER_H_
